...
public class getpesan {
    ...
    public getpesan(String pemboxId, String pemboxNama, String pemboxNohp, String pemboxAlamat, String pemboxSppil, String pemboxTanggal,String pemboxPaket,String pemboxPorsi, int pemboxTotal) {
